...
public class Turret extends SubsystemBase {
    ...
    public Turret() {
        ...
        //talonFXSConfiguration.SoftwareLimitSwitch.ForwardSoftLimitThreshold = TurretConstants.MAX_ANGLE.in(Degrees);
        //talonFXSConfiguration.SoftwareLimitSwitch.ReverseSoftLimitThreshold = TurretConstants.MIN_ANGLE.in(Degrees);
